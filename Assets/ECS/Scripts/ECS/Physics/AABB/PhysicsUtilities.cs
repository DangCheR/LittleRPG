...
namespace LittleRPG.Physics
{
    ...
    public struct PhysicsUtilities
    {
        ...
        /// 判断两个圆相交
        /// </summary>
        /// <param name="Apositon"></param>
        /// <param name="Aradius"></param>
        /// <param name="Bpositon"></param>
        ...
        {
            return shape.LowerBound.x <= point.x
                && point.x <= shape.UpperBound.x
                && shape.LowerBound.y <= point.y
                && point.y <= shape.UpperBound.y;
        }
            ...
            Ray ray)
        {
            ...
            switch (shape.shapeType)
            {
                ...
                case ShapeType.Box:
                    ...
                    return IntersectBox(shape.Position, shape.Rotation * Mathf.Deg2Rad, box.ValueRO.dimensions * 0.5f, ray);
                default:
                    return 0;
            }
        }
        ...
        /// <summary>
        /// 从CircleShapeData中获取AABB，为了插入树中
        /// </summary>
        ...
        {
            Vector2 halfExtents = boxData.dimensions * 0.5f;
            rot *= Mathf.Deg2Rad;
